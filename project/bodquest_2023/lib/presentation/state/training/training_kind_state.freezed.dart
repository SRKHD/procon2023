...
mixin _$TrainingKindState {
  TrainingKind get kind => throw _privateConstructorUsedError;
...
class _$TrainingKindStateImpl implements _TrainingKindState {
  const _$TrainingKindStateImpl({required this.kind});
  ...
  @override
  String toString() {
    return 'TrainingKindState(kind: $kind)';
  }
...
abstract class _TrainingKindState implements TrainingKindState {
  const factory _TrainingKindState({required final TrainingKind kind}) =
      _$TrainingKindStateImpl;

  @override
  TrainingKind get kind;
  @override
  @JsonKey(ignore: true)
  _$$TrainingKindStateImplCopyWith<_$TrainingKindStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
